...
public class StockService {
    ...
    public ResponseEntity<?> requestStockAction(Long productId, int quantity, String type) {
        ...
        System.out.println(type+ " "+ quantity +" " +product.getQuantityInStock());
        ...
        stockAction.setLastUpdated(new Date());
        stockAction.setQuantityBeforeAction(product.getQuantityInStock());

        StockAction saveProduct= stockActionRepository.save(stockAction);

        StockUpdateMessage message = new StockUpdateMessage(saveProduct, "add");
        System.out.println(" product update : " + message.getAction());
        messagingTemplate.convertAndSend("/stocks/update", message);
    ...
    public ResponseEntity<String> reviewStockAction(Long actionId, String status) {
        ...
        StockAction saveProduct= stockActionRepository.save(stockAction);
        StockUpdateMessage message = new StockUpdateMessage(saveProduct, "update");
        System.out.println(" product update : " + message.getAction()+" " +message.getStockAction().getId());
        messagingTemplate.convertAndSend("/stocks/update", message);
