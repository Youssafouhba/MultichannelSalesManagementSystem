    ...
    >
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        <View style={styles.nameParent}>
          ...
          <View style={[tw`mt-10 mb-4 flex-row`, { width: '100%',justifyContent: "center",}]}>
              <Text style={[styles.alreadyRegisteredLog, styles.createNewAccountPosition]}>
                Already Registered?
              </Text>
              <Pressable
                style={[tw`ml-1 -mt-1`, styles.secondaryButton, styles.secondaryLayout]}
                onPress={() => navigation.navigate("Authen")}
              >
                <Text style={[tw` ml-1 -mt-1`,styles.here, styles.hereTypo]}>Login</Text>
              </Pressable>
          </View>
